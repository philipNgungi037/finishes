...
const Header = () => {
  return (
    <>
      ...
      <header className='header-main hidden lg:flex justify-between items-center mt-4 px-0 lg:px-16 shadow-lg sticky top-0 z-50'>
        <Logo />
        <Search />
        <NavList />
      </header>
      ...
      <header className='header-main lg:hidden grid grid-cols-2 items-center sticky top-0 z-50'>
        <Logo />
        <NavList />
